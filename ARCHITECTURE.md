...
│  │  • Включает word-level timestamps                        │   │
│  │  • VAD фильтрация                                        │   │
│  └──────────────────────────────────────────────────────────┘   │
│                                                                  │
│  Пример выхода:                                                 │
...
**Модели:**
- `large-v3` (рекомендуется, ~10GB VRAM)
- `large-v2` (альтернатива)
- `medium` (для экономии памяти, ~5GB VRAM)

**Параметры:**
- VAD filtering для удаления пауз
- Word-level timestamps для анимации
- Beam search для точности
